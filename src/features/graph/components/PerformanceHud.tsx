...
function PerformanceHud({ stats }: PerformanceHudProps) {
  return (
    <aside className="performance-hud pointer-events-auto absolute bottom-2.5 right-2.5 z-[80] rounded-xl border border-slate-500/70 bg-slate-950/78 px-2.5 py-1.5 text-slate-100 shadow-[0_12px_28px_rgba(0,0,0,0.4)] backdrop-blur-md sm:bottom-3 sm:right-3">
